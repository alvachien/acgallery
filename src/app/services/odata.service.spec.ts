...
describe("OdataService", () => {
    ...
    it("should return expected data (called once)", () => {
      service.createAlbum(tbcAlbum).subscribe({
        next: (rtn: Album) => {
          expect(rtn.Title)
            .withContext("should return expected data")
            .toEqual(tbcAlbum.Title);
          expect(rtn.Desp)
            .withContext("should return expected data")
            .toEqual(tbcAlbum.Desp);
        },
        error: (fail: any) => {
          // Empty
        },
  ...
  describe("getPhotoEXIF", () => {
    ...
    it("should return expected data (called once)", () => {
      ...
      const req: any = httpTestingController.expectOne((requrl: any) => {
        return (
          requrl.method === "GET" && requrl.url === `${photoAPI}('photo-id')`
        );
      });
    ...
    it("should return expected data when create success", () => {
      service.createPhoto(tbcPhoto).subscribe({
        next: (rtn: Photo) => {
          expect(rtn.photoId)
            .withContext("should return expected data")
            .toEqual(tbcPhoto.photoId);
          expect(rtn.desp)
            .withContext("should return expected data")
            .toEqual(tbcPhoto.desp);
        },
        error: (fail: any) => {
          // Empty
        },
