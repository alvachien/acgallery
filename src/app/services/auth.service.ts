...
export class AuthService {
  ...
  constructor(
    ...
    writeConsole(
      "ACGallery [Debug]: Entering AuthService constructor...",
  ...
  public doLogin() {
    writeConsole(
      "ACGallery [Debug]: Entering AuthService logon...",
      ConsoleLogTypeEnum.debug
    );
  ...
  public doLogout() {
    writeConsole(
      "ACGallery [Debug]: Entering AuthService doLogout...",
      ConsoleLogTypeEnum.debug
    );
  ...
  public getUserDetail(forceReload = false): Observable<UserDetail> {
    if (!this._isUserDetailLoaded || forceReload) {
      ...
      headers = headers
        ...
        .append(
          "Authorization",
          "Bearer " + this.authSubject.getValue().getAccessToken()
        );
      const params: HttpParams = new HttpParams();
      const apiurl = `${environment.apiRootUrl}UserDetails('${this.authSubject
        .getValue()
        .getUserId()}')`;
