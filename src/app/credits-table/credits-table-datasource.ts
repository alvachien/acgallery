...
const EXAMPLE_DATA: CreditsTableItem[] = [
  {id: 1, name: 'Hydrogen'},
  {id: 2, name: 'Helium'},
  {id: 3, name: 'Lithium'},
  {id: 4, name: 'Beryllium'},
...
export class CreditsTableDataSource extends DataSource<CreditsTableItem> {
  data: CreditsTableItem[] = EXAMPLE_DATA;
   ...
   */
  private getPagedData(data: CreditsTableItem[]) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: CreditsTableItem[]) {
