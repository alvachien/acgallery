...
import { Album, SelectableAlbum, AlbumPhotoByAlbum, AlbumPhotoLink,
...
export class AlbumService {
    ...
    constructor(private http: Http,
        ...
        this.albumUrl = environment.AlbumAPIUrl;
    ...
    public updateAlbumPhotoByAlbum(apba: AlbumPhotoByAlbum) {
        ...
        return this.http.post(environment.AlbumPhotoByAlbumAPIUrl, data, { headers: headers })
            .map(response => response.json());
    }
    ...
    public updateAlbumPhotoByPhoto(apbp: AlbumPhotoByPhoto) {
        ...
        this.http.post(environment.AlbumPhotoByPhotoAPIUrl, data, { headers: headers })
            .map(response => response.json());
    }
